...
public class removeProductToOrderModify extends JFrame {
	...
	public removeProductToOrderModify(frameController cont) {
		...
		removeProductButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					orderController.actionOrder(bussinessEvent.ELIMINAR_PRODUCTO_PEDIDO_MODIFY, productId + "_" + productAmount + "_" + currentOrder + "_");
