...
/**
 * Interfaz gráfica para eliminar pedidos del almacén.
 * @author Borja y Javier
 *
 */

@SuppressWarnings("serial")
public class removeProductToStock extends JFrame {

	/* Controladores */
    private stockController stockController;		// Controlador del subsistema del almacén
    ...
    /**
     * Constructor de la interfaz gráfica para eliminar productos del almacén.
     * @param cont 	Controlador de la interfaz gráfica.
     */
    
    public removeProductToStock(frameController cont) {
        ...
        removeProductButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	try {
	            	...
	            	stockController.actionStock(bussinessEvent.ELIMINAR_PRODUCTO_STOCK, productId + "_" + productAmount + "_");
