...
public class addProductToOrder extends JFrame {
    ...
    public addProductToOrder(frameController cont) {
        ...
        addProductButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	try {            		
	            	...
	            	orderController.actionOrder(bussinessEvent.AÑADIR_PRODUCTO_PEDIDO, productId + "_" + productName + "_" + productTag + "_" + productAmount + "_" + productPrice + "_" + currentOrder + "_");
