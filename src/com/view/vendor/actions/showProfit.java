...
/**
 * Interfaz gráfica para mostrar el balance diario
 * @author JAVIER
 *
 */

@SuppressWarnings("serial")
public class showProfit extends JFrame implements Watcher {
    ...
    /**
     * Constructor de la interfaz gráfica para mostrar balance diario.
     * @param cont 	Controlador de la interfaz gráfica.
     */
    
    public showProfit(frameController cont) {
        super("Ver caja");
	...
	public void update(Watchable o, Object arg) {
		...
		case bussinessEvent.MOSTRAR_BALANCEDIA:
			textLabel.setText("El balance del día es: " + cadena);
			break;
		}
