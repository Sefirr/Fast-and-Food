...
/**
 * Clase derivada de orderCommandInterpreter que representa el comando removeProduct.
 * @author Javier
 *
 */

public class removeProduct extends orderCommandInterpreter {
	...
	public removeProduct(int id, int amount, int orderIdentiffier) {
		super();
		this.id = id;
		this.amount = amount;
	...
	public Object execute() {
		service.removeProduct(id, amount, orderIdentiffier);
	...
	public int bussinessEvent() {
		// TODO Auto-generated method stub
		return bussinessEvent.ELIMINAR_PRODUCTO_PEDIDO;
	}
