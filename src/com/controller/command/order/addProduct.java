...
/**
 * Clase derivada de orderCommandInterpreter que representa el comando addProduct.
 * @author Javier
 *
 */

public class addProduct extends orderCommandInterpreter {
	...
	public addProduct(int id, String name, String Tag, int amount, double price, int orderIdentiffier) {
		super();
		this.id = id;
		this.name = name;
		this.Tag = Tag;
	...
	public Object execute() {
		...
		service.addProduct(id, name, Tag, amount, price, orderIdentiffier);
	...
	public orderCommandInterpreter Command(String arg0, String arg1, String arg2, String arg3, String arg4, String arg5) {
		// TODO Auto-generated method stub
		try {
			return  new addProduct(Integer.parseInt(arg0), arg1, arg2, Integer.parseInt(arg3), Double.valueOf(arg4), Integer.parseInt(arg5));
	...
	public int bussinessEvent() {
		// TODO Auto-generated method stub
		return bussinessEvent.AÑADIR_PRODUCTO_PEDIDO;
	}
